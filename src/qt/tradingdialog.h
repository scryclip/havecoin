...
private slots:
    ...
    QString BuyHAV(QString OrderType, double Quantity, double Rate);
    QString SellHAV(QString OrderType, double Quantity, double Rate);
