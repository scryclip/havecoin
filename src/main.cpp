...
const string strMessageMagic = "Havecoin Signed Message:\n";
...
int64_t GetProofOfStakeReward(int nHeight, int64_t nCoinAge, int64_t nFees)
{
    ...
    if (nHeight >= 1000000) {
        nSubsidy >>= (nHeight / 1000000);  // halving every 1m blocks ~ 4 years
    }
    return nSubsidy + nFees;
}
