...
static const int64_t STATIC_POS_REWARD = 3.5 * COIN; //Constant reward of 3.5 HAV per COIN 
...
static const unsigned int DEFAULT_BLOCK_PRIORITY_SIZE = 5000000;
...
static const int64_t MAX_MONEY = 10000000 * COIN; // 10M coins
